<template>
	<tr class="ingredient" :id="myid">
		<td>
			<input type="number" :v-model="numVmodl" title="Enter the amount of the ingredient" alt="Enter the amount of the ingredient" :name="numName" :id="numName" :size="numSize" :maxlength="numSize" placeholder="#" @blur="$emit('numinput', parseInt($event.target.value))" />
		</td>
		<td>
